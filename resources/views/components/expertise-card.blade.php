...
<article class="reveal group relative flex flex-col justify-between bg-soot border border-white/5 p-8 md:p-10 min-h-[340px] hover:border-gold/40 transition-colors duration-700">
